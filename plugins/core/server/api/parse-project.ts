import { BaseProject, Project } from '@/plugins/core/server/api/lib/project';
import { getFlatFilesRecursively } from './lib/walk-project';
...
async function getFiles(projectPath: string) {
  ...
  const filesWithContent = await getFlatFilesRecursively(projectPath);
